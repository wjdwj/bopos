...
<script>
	import { orderCaigou,orderListNo,orderLei,orderShen,orderShenList,orderShenCan,orderShenShen,SupplierList,diaoboList } from '@/api/shangpin'
...
//				父级传来的值
		...
		methods: {
			...
			getList() {
				this.msg = this.message;
				orderListNo(this.splistQuery).then(res => {
					console.log(res)
