    ...
    <div class="warp">
        ...
        <div class="main">
            <div class="top">
                ...
                <div class="box">
                    <span>类型</span>
                    <el-select v-model="listQuery.type"  clearable @change="changeScreen" placeholder="请选择">
                        <el-option
                ...
                <div class="box">
                    <el-button type="primary" @click="isEdit = false;jiluVisible = true;">会议/学习记录</el-button>
                </div>
            </div>
            <div class="date">
                <span>时间：</span>
            ...
            <div class="biao">
                <div class="table">
                    <el-table :data="tableData1" style="width: 100%" v-loading="tableLoading">
                        ...
                        <el-table-column prop="fullName" label="油站" align="center"></el-table-column>
                        ...
                        <el-table-column label="类型" align="center">
                            <template slot-scope="scope">
                                <span v-show="scope.row.type==1">会议</span>
                                <span v-show="scope.row.type==2">活动</span>
                                <span v-show="scope.row.type==3">培训</span>
                                <span v-show="scope.row.type==4">日常学习</span>
                                <span v-show="scope.row.type==5">预案演练</span>
                            </template>
                        </el-table-column>
            ...
            />
            <el-dialog
                :visible.sync="jiluVisible"
                :title="'会议/学习记录' + (isEdit ? '编辑' : '录入')"
                width="980px"
            >
                <el-form ref="addForm" :rules="rules" :model="addFormData" label-width="80px">
                        ...
                        <el-col :span="8">
                            <el-form-item label="加油站" prop="shortName">
                                <el-input
                                    ...
                                    v-for="item in stationOptions"
                                    :key="item.id"
                                    v-if="belong_id == item.id"
                                    :value="item.shortName"
                                ></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="录入人" prop="modifier">
                                <el-input v-model="addFormData.modifier" placeholder="录入人"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-form-item label="主题" prop="name">
                        <el-input placeholder="主题" v-model="addFormData.name"></el-input>
                    </el-form-item>
                    <el-form-item label="参加人员" prop="attendees">
                        <el-input placeholder="参加人员" v-model="addFormData.attendees"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label>
                        <el-button type="primary" @click="addItem(0);">保存</el-button>
                        <el-button type="primary" @click="addItem(1);">提交</el-button>
                        <el-button type="primary" @click="jiluVisible = false">关闭</el-button>
                    </el-form-item>
                </el-form>
            </el-dialog>

            <el-dialog :visible.sync="seeJiluVisible" title="查看会议/学习记录" width="980px">
                <el-form ref="addForm" label-width="80px">
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="加油站" prop="shortName">{{ addFormData.short_name }}</el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item
                                label="录入日期"
                                prop="createTime"
                            >{{ addFormData.create_time | dateTime }}</el-form-item>
                        </el-col>
                    </el-row>
                    <el-form-item label="类型" prop="type">
                        <span
                            ...
                            :key="item.value"
                            v-if="addFormData.type == item.value"
                        >{{ item.label }}</span>
                    </el-form-item>
                    <el-form-item label="主题" prop="name">{{ addFormData.name }}</el-form-item>
                    <el-form-item label="参加人员" prop="attendees">{{ addFormData.attendees }}</el-form-item>
                    <el-form-item label="内容" prop="content">{{ addFormData.content }}</el-form-item>
                </el-form>
            </el-dialog>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            getMeetinglist(this.listQuery).then(res => {
                console.log(res);
                this.tableData1 = res.data.rows;
                this.total = res.data.total;
                this.tableLoading = false;
            });
            // getMeetinglist(data).then(response => {
            //     console.log(response.data);
        ...
        edit(id) {
            ...
            getMeetingById({ id: id }).then(res => {
                if (res.data) {
                    this.addFormData = res.data;
                    this.addFormData.createTime = res.data.create_time;
                }
            });
        }
    },
