    ...
    <div class="warp">
        <div class="header">
            <div class="top">
                ...
                <!-- <div class="box">
                    <span>加油站</span>
                    <el-select @change="changeScreen" v-model="listQuery.stationId" placeholder="请选择">
                        <el-option
        ...
        <div class="main">
            ...
            <el-dialog
                ...
                :title="'日志' + (isEdit ? '编辑' : '录入')"
                width="1080px"
            >
                <el-form ref="addForm" :rules="rules" :model="addFormData" label-width="110px">
                    <el-row :gutter="20">
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item label="录入人" prop="creater">
                                <el-input v-model="addFormData.creater" placeholder="录入人"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="天气" prop="weather">
                                <el-select v-model="addFormData.weather"  clearable placeholder="请选择天气">
                                    <el-option
                        ...
                        <el-col :span="8">
                            <el-form-item label="星期" prop="day">
                                <el-input disabled v-model="addFormData.day" placeholder="星期"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
            ...
            <el-dialog :visible.sync="seeJiluVisible" title="查看日志" width="1080px">
...
export default {
    ...
    watch: {
        ...
        "addFormData.createTime": function(val) {
            this.addFormData.day = this.getDateDay(val)
        }
    }
};
</script>
