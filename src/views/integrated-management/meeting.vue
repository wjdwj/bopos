    ...
    <div class="warp">
        ...
        <div class="main">
            <div class="top">
                ...
                <div class="box">
                    <span>类型</span>
                    <el-select v-model="leixing" clearable placeholder="请选择">
                        <el-option
            ...
            <div class="biao">
                <div class="table">
                    <el-table :data="tableData1" style="width: 100%">
                        ...
                        <el-table-column prop="zhuti" label="主题" align="center"></el-table-column>
                        <el-table-column
                            prop="zhanjingli"
                            label="站经理（临时授权人）"
                            align="center"
            ...
            <el-dialog :visible.sync="jiluVisible" title="会议/学习记录录入" width="90%">
                ...
                <div class="riqi">
                    ...
                    <el-date-picker v-model="value1" unlink-panels  type="date" placeholder="选择日期"></el-date-picker>
                </div>
                <div class="leixing">
                    <span>类型</span>
