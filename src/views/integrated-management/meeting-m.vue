    ...
    <div class="warp">
        <div class="header">
            <div class="top">
                ...
                <div class="box">
                    <span>类型</span>
                    <el-select v-model="listQuery.type"  clearable placeholder="请选择" @change="changeScreen">
                        <el-option
                ...
                <!-- <div class="box">
                    <el-button type="primary" @click="jiluVisible = true">会议/学习记录+</el-button>
                </div>-->
            </div>
        ...
        <div class="main">
            ...
            <!-- <pagination :total="total" :page.sync="listQuery.pageNum" :limit.sync="listQuery.pageSize" @pagination="getList" /> -->
            <!-- <el-dialog :visible.sync="jiluVisible" title="会议/学习记录录入" width="90%">
                <div class="dbox">
                    <div class="box">
                        <span>加油站</span>
