<template>
    <div class>
        ...
        <div class="main">
            ...
            <div slot="footer" class="dialog-footer" style="margin: 24px;margin-top: 40px;margin-left: 70px;">
              <el-button type="danger" @click="jujueVisible=true">拒绝</el-button>
              <el-button  type="primary" @click="ent">确认</el-button>
              <el-button  type="" @click="prev">关闭</el-button>
            </div>
        </div>

        <el-dialog :visible.sync="jujueVisible" title="拒绝原因" width="50%">
            <div class="screen" style="text-align: center;">
                <el-input v-model="tianjia.remark" placeholder="请输入拒绝原因" />
            </div>
