<template>
    <div class="warp">
                            ...
                            <el-table-column label="商品组" align="center">
                                <el-table-column label="商品" align="left">
                                    <template slot-scope="scope">
                                        <div
                                            class="zu"
                                            v-for="(item, index) in scope.row.commodityGroup"
                                            :key="index"
                                        >
        ...
        <el-dialog :visible.sync="dialogFormVisible" title="选择商品" width="80%">
            ...
            <!-- @selection-change="singleHandleSelectionChange" -->
            <el-table
                ref="filterTable"
                :data="commodityData"
            ...
            >
                ...
                <el-table-column prop="goodsTypeName" label="商品类型" sortable min-width="150"></el-table-column>
                <el-table-column prop="goodsName" label="商品名称" sortable min-width="150"></el-table-column>
                <el-table-column prop="brand" label="品牌" width="150"></el-table-column>
                <el-table-column prop="repertory" label="库存" sortable width="100"></el-table-column>
                <el-table-column prop="unit" label="单位" width="150"></el-table-column>
                <el-table-column prop="price " label="单价" sortable width="150"></el-table-column>
                <el-table-column label="规格" sortable width="150">
                    <template slot-scope="scope">
                        <span>{{scope.row.specAmount}}{{scope.row.specUnit}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="expirationDay" label="保质期" sortable width="150"></el-table-column>
                <el-table-column align="right" v-if="0">
...
export default {
    ...
    methods: {
        get() {
            ...
            getGoodsTypeList(data).then(response => {
                console.log(response.data);
        ...
        addGroup() {
            ...
            if (this.multipleSelection.length > 0) {
                for (var i = 0; i < this.multipleSelection.length; i++) {
                    this.ruleData[0].commodityGroup.push(
        ...
        renderHeader(h, { column, $index }) {
            ...
            return h("span", [
                ...
                h(
                    ...
                    {
                        style:
                            'margin-left: 5px; border:0;background-color:#F5F9FC;font-size: 25px;padding: 0;color:#5B8DFF;"',
                        on: {
                            click: that.add
                        }
                    },
        ...
        tijiao() {
            ...
            if (this.promotionType == 5) {
                ...
                for (let i = 0; i < this.ruleData.length; i++) {
                    if (
                        this.ruleData[i].commodity.id == "" ||
                        this.ruleData[i].commodity.id == null
                    ) {
                        this.$message({
                ...
                for (let i = 0; i < this.ruleData.length; i++) {
                    ...
                    if (
                        this.ruleData[i].giftGoods[0].id == "" ||
                        this.ruleData[i].giftGoods[0].id == null
                    ) {
                        this.$message({
                ...
                for (let i = 0; i < this.ruleData.length; i++) {
                    ...
                    if (
                        this.ruleData[i].discount <= 0 ||
                        this.ruleData[i].discount > 100
                    ) {
                        this.$message({
                            message:
                                "第" + (i + 1) + "条规则，请输入正确的优惠折扣",
                            type: "warning"
                        });
                        return;
                    }
                ...
                for (let i = 0; i < this.ruleData.length; i++) {
                    ...
                    typeList.push({
                        goodsId: this.ruleData[i].giftGoods[0].id,
                        minimumCharge: this.ruleData[i].promotionalAmount,
                        discount: this.ruleData[i].discount
                    });
                }
                ...
                for (let i = 0; i < this.ruleData.length; i++) {
                    ...
                    for (
                        let j = 0;
                        j < this.ruleData[i].commodityGroup.length;
                        j++
                    ) {
        ...
        //单选
        // singleHandleSelectionChange(val) {
        //     this.multipleSelection = []
        //     if (val.length) {
        //         this.multipleSelection.push(val[0]);
        //     }
        //     console.log('单选')
