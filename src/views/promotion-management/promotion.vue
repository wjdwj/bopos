...
<div class="warp">
  <div class="header" style="display:flex;justify-content:  space-between;">
    <h3><span></span>促销管理</h3>
        <div class="shenqing">
        <a href="#/promotions/oilApplication"><el-button type="primary">油品促销申请</el-button></a>
        <a href="#/promotions/commodityApplication"><el-button type="primary">商品促销申请</el-button></a>
        <a href="#/promotions/mixedPromotion"><el-button type="primary">油商互动申请</el-button></a>
      </div>
	</div>
  <div class="main">
    <div class="top">
    ...
    <div class="biao">
      <div class="table">
        ...
        <el-table
          ...
          <el-table-column label="说明" min-width="305" align="center" >
            <template slot-scope="scope">
             <span class="shuoming">购买 {{ scope.row.commodity.goodsName }}   满{{scope.row.discount}}，赠送{{scope.row.givingNum}}个{{scope.row.givingName}}</span>
            </template>
          </el-table-column>
        </el-table>
        <!-- 商品订单满金额，总价立减 -->
