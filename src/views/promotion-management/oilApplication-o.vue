                ...
                <el-row>
                  ...
                  <p v-show="promotionType=='3'">买指定油品达到一定金额，总价扣减折扣金额</p>
                            ...
                            <div class="inp">
                                ...
                                <div class="right">
                                    <span>{{station}}</span>
                                    <!-- <el-input disabled v-model="station" placeholder="单行输入" style="width: 200px;"></el-input> -->
                                </div>
                            </div>
                            <div class="inp">
                                <div class="left t">
        ...
        tijiao() {
            ...
            if (this.promotionType == 1) {
                for (let i = 0; i < this.tbOilPromotionRulesList.length; i++) {
                    if (
                        this.tbOilPromotionRulesList[i].oilsId == "" ||
                        this.tbOilPromotionRulesList[i].oilsId == null
                    ) {
                        this.$message({
                ...
                for (let i = 0; i < this.tbOilPromotionRulesList.length; i++) {
                    ...
                    if (
                        this.tbOilPromotionRulesList[i].discount < 0 ||
                        this.tbOilPromotionRulesList[i].discount > 100
                    ) {
                        this.$message({
                            message:
                ...
                for (let i = 0; i < this.tbOilPromotionRulesList.length; i++) {
                    ...
                    if (
                        this.tbOilPromotionRulesList[i].promotionalAmount <= 0
                    ) {
                        this.$message({
                            message:
                    ...
                    typeList.push({
                        goodsId: this.tbOilPromotionRulesList[i].oilsId,
                        minimumCharge: this.tbOilPromotionRulesList[i]
                            .promotionalAmount,
                        discount: this.tbOilPromotionRulesList[i].discountAmount
                    });
                }
