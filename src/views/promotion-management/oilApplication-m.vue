        ...
        <el-row>
          <el-col :span="12"><div class="grid-content bg-purple">
            ...
            <div class="inp">
              ...
              <div class="right">
                <el-select v-model="station" clearable multiple placeholder="请选择" style="width: 280px;">
                  <el-option
              ...
              <div class="right">
                  <div class="ipt">
                    ...
                    <div class="right">
                      ...
                      <el-input v-model="totalTimes" size="mini" :disabled="frequency!=1" :min="1" type="number" placeholder="0" style="width: 100px;"></el-input>
                      <el-radio v-model="frequency" label="2" style="margin-left: 20px;">总/次</el-radio>
                      <el-input v-model="dayTimes" size="mini" :disabled="frequency!=2" :min="1" type="number" placeholder="0" style="width: 100px;"></el-input>
                    </div>
...
export default {
  ...
  methods: {
    get(){
      ...
      //         console.log(response.data)
      //         // stationInfo
      //         this.station = response.data.stationInfo.fullName
      //       }) 
      //   }) 
    },
    //时间段是否选中
