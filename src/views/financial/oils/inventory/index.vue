  ...
  <div class="warp inventory">
    ...
    <div class="main">
      <div class="top">
        <div class="box">
          <span>公司</span>
          <el-select @change="change" v-model="company" clearable placeholder="请选择" style="width:140px" clearable>
            <el-option
        ...
        <div class="box">
          <span>加油站</span>
          <el-select v-model="station" placeholder="请选择"  clearable style="width:140px" clearable>
            <el-option
        ...
        <div class="box">
          <span>品号</span>
          <el-select v-model="oilsId" placeholder="请选择" clearable style="width:140px" clearable>
            <el-option
...
export default {
  ...
  methods:{
    ...
    //导出
    exportTable(){
      var tHeaders = ['油品品号',  '库存（V20）', '油品入库-实收（20）', '油品入库-损益', '油品销售', '检测油', '油品出库-出库（V20）', '油品出库-损益', '油品期末库存-库存（V20）','销售损益'];
      var filterVals = [ 'oilsName',  'initialInventory', 'enterhouseActual', 'enterhouseConsume','sales','tests', 'outhouseActual', 'outhouseConsume', 'finalInventory','salesConsume'];
      var name = '油品进销存报表'
