...
export default {
  ...
  methods:{
    ...
    exportTable(){
      if(this.fangshixuanze==1){
        var tHeaders = ['油站', '实收金额-合计', '实收金额-现金', '实收金额-微信','实收金额-支付宝','实收金额-银联卡','实收金额-会员卡','实收金额-老会员','折扣-电子券','折扣-会员卡','折扣-促销'];
        var filterVals = ['stationName','sum', 'cash', 'wechat','alipay','card','member','oldMember','discountElec','discountMember','discountPro'];
        var name = '商品销售报表'
