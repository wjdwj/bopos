  ...
  <div class="warp">
    ...
    <div class="main">
      <div class="top">
        ...
        <div class="box">
          <span>设备</span>
          <el-select v-model="equipment" clearable placeholder="请选择">
            <el-option
    ...
    <!-- 异常交易监控处理 -->
    <el-dialog :visible.sync="shebeiHandleVisible" width='50%' title="异常处理">
      <div class="see">
        <p>异常原因与处理：</p>
        <el-input
            type="textarea"
...
export default {
  data() {
    return {
      ...
      num:0,
      equipment:'',//设备
      equipmentOptions:[],//设备选择
      tableData:[{}],
      shebeiSeeVisible:false,
      shebeiHandleVisible:false,
      pickerOptions2: {
          shortcuts: [{
            text: '最近一周',
            onClick(picker) {
  ...
  methods:{
    ...
    handle(index,row){
        this.shebeiHandleVisible = true
        console.log('异常')
    },
    handleEnt(index,row){
        this.shebeiHandleVisible = false
        console.log('异常')
    },
    //返回上一页
    prev() {
