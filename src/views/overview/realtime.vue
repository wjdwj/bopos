...
<template>
    <div class="warp">
        <div class="top">
            ...
            <div class="box">
                <span>地区</span>
                <el-select v-model="shengId" @change="sanduanChange" clearable placeholder="请选择">
                    <el-option
                        v-for="item in sheng"
                        :key="item.id"
                        :label="item.district"
        ...
        <div class="topbang">
            ...
            <div class="shanghu">
                ...
                <ul>
                   <li v-for="(item,index) in stationTop" :key="item.company_name">
                        <span v-if="index==3">4</span>
                         <span v-else-if="index==4">5</span>
                         <span v-else></span>
        ...
        <div class="biao">
            <div class="header">
                <h3>
                    <span></span>24小时收银金额走势
                </h3>
            </div>
            <el-tabs v-model="activeName" @tab-click="handleClick" style="padding-left:16px">
...
import { youpinlist,sanduangailan,zhengtiqushi} from "@/api/youpinbaobiao";
    ...
    methods: {
        ...
        sanduanChange(){
            ...
            sanduangailan(data).then(res=>{
                ...
                this.stationTop=res.data.companyTop;
