  ...
  <div class="app-container account_post">
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <el-table :key="tableKey" :data="list" fit highlight-current-row style="width: 100%;">
        ...
        <el-table-column label="资金缴存" min-width="90" align="center">
          <template slot-scope="scope">
						  <el-switch
						    v-model="scope.row.is_permit_check"
						    active-color="#13ce66"
        ...
        <el-table-column label="收银终端登录" min-width="175" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.is_permit_login" active-color="#13ce66" disabled inactive-color="#ff4949" :active-value="1" :inactive-value="0"/>
          </template>
        </el-table-column>
        <el-table-column label="后台登录" min-width="130" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.is_admin" active-color="#13ce66" disabled inactive-color="#ff4949" :active-value="1" :inactive-value="0"/>
          </template>
        </el-table-column>
        <el-table-column label="销售数据" min-width="130" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.is_sales_data" active-color="#13ce66" disabled inactive-color="#ff4949" :active-value="1" :inactive-value="0"/>
          </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="gangweitianjia" title="岗位添加" class="gwgl_tab">
      <el-form ref="gwtianjiaForm" :rules="rules" :model="gwtianjiaform" label-position="left" label-width="80px">
	        ...
	        <div style="margin-left: 60px;">
		        <el-form-item label="资金缴存" style="margin-bottom: 0;">
		          <el-switch
							  v-model="gwtianjiaform.is_permit_check"
							  active-color="#13ce66"
	        ...
	        <el-form-item label="后台登录">
	          <el-switch
						  v-model="gwtianjiaform.is_admin"
						  active-color="#13ce66"
						  inactive-color="#cccccc"
						  active-value="1"
    					inactive-value="0">
	        ...
	        <el-form-item label="收银终端登录" label-width="110px">
	          <el-switch
						  v-model="gwtianjiaform.is_permit_login"
						  active-color="#13ce66"
						  inactive-color="#cccccc"
						  active-value="1"
    					inactive-value="0">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" :loading="loading1" @click="tijiaogangwei()">确认</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog :visible.sync="gangweixiugai" title="岗位修改" class="gwgl_tab">
      <el-form ref="gwxiugaiForm" :rules="rules" :model="Detail" label-position="left" label-width="80px">
	        ...
	        <div style="margin-left: 60px;">
    	        <el-form-item label="资金缴存" style="margin-bottom: 0;">
    	          <el-switch
    						  v-model="Detail.is_permit_check"
    						  active-color="#13ce66"
    						  inactive-color="#cccccc"
    						  :active-value="1"
        					:inactive-value="0">
	        ...
	        <el-form-item label="收银终端登录" label-width="110px">
	          <el-switch
						  v-model="Detail.is_permit_login"
						  active-color="#13ce66"
						  inactive-color="#cccccc"
						  :active-value="1"
    					:inactive-value="0">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" :loading="loading2" @click="xiugaiQ()">确认</el-button>
      </div>
    </el-dialog>
      ...
      getList() {
	    ...
	    gangweiTj(){
	    	this.gangweitianjia = true
		      ...
		      this.$refs.gwtianjiaForm.resetFields()
		      this.$refs.tree1.setCheckedKeys([]);
		      this.loading1 = false
	    },
	    tijiaogangwei(){
	    	this.digui(this.treeList)
	    	let shuzu=this.$refs.tree1.getCheckedKeys();
          ...
          for (var x in shuzu) {           
	    	...
	    	this.gwtianjiaform.auth=this.$refs.tree1.getHalfCheckedKeys();
	    	this.gwtianjiaform.auth=this.gwtianjiaform.auth.concat(shuzu);
//	    	console.log(this.$refs.tree.getHalfCheckedKeys())
      ...
      xiugaiQ(){
      	...
      	this.digui(this.treeList);
	    	...
	    	shuzu=shuzu.concat(this.$refs.tree.getHalfCheckedKeys());
	    	let auths=[];
	    	/*for (var s in this.treeLast) {  
	          for (var x in shuzu) {           
	              if (this.treeLast[s] == shuzu[x]) {  
