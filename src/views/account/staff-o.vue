  ...
  <div class="app-container account_staff">
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <div class="items">
        ...
        <div style="float: right;margin-left: auto;">
        	<el-button type="primary" @click="tianjiaTk()" style="float: none;">员工添加</el-button>
        	<el-button type="primary" @click="shouquanmima = true" style="float: none;margin-left: 30px;">授权密码</el-button>
        </div>
      </div>
    ...
    <el-dialog :visible.sync="yuangongtianjia" title="员工添加" class="ygtj_tab" @open="qingtianjia">
      <el-form ref="dataForm" :rules="rules" :model="addData" label-position="left" label-width="80px">
	        ...
	        <el-form-item label="入职时间" prop="entryTime">
	          ...
	          <el-select v-model="addData.status"  clearable class="filter-item" @change="gaiqiyong">
	            <el-option v-for="item in zaizhi" :key="item.id" :label="item.name" :value="item.id"/>
	          </el-select>
	        </el-form-item>
	        ...
	        <el-form-item label="身份证号" prop="idCard">
	          <el-input  v-model="addData.idCard" maxlength="18" minlength="18"/>
	        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
		...
		<!--授权密码弹框-->
    	<el-dialog :visible.sync="shouquanmima" title="授权密码" class="ygtj_tab" width="300px">
			<div class="in">
      			<el-input readonly placeholder="授权密码" :maxlength="6" :minlength="4" v-model="shouquan" style="width: 50%;"/>
      			<el-button class="el-icon-refresh" @click="shouquan = getPassword(1000,999999)"></el-button>
			</div>

      <div slot="footer" class="dialog-footer">
        <el-button @click="shouquanmima = false">取消</el-button>
        <el-button type="primary" style="margin-left:10px" @click="shouquanqueren">确认</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog :visible.sync="yuangongxiugai" title="员工信息修改" class="ygtj_tab">
      <el-form ref="dataForm2" :rules="rules" :model="ygXiang" label-position="left" label-width="80px">
	        ...
	        <el-form-item label="身份证号" prop="idCard">
	          <el-input  v-model="ygXiang.idCard" maxlength="18" minlength="18"/>
	        </el-form-item>
	        <el-form-item label="生日">
	          <el-date-picker disabled
...
import { updateCode } from '@/api/shuju'
...
export default {
  ...
  created() {
		...
		this.getGWList()
		this.youzhanLie()
		this.shouquan = this.getPassword(1000,999999)
  },
  methods: {
  		getPassword(lower, upper){
	    ...
	    shouquanqueren(){
				var data = {
					authorizationCode:this.shouquan
				}
				updateCode(data).then(res=>{
					console.log(res)
					this.shouquanmima = false
	    	})
			},
	    gaiqiyong2(val){
	    	console.log(val)
