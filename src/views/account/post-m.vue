  ...
  <div class="app-container account_post">
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <el-table :key="tableKey" :data="list" fit highlight-current-row style="width: 100%;">
        ...
        <el-table-column label="是否允许登录收银机终端" min-width="175" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.is_permit_login" active-color="#13ce66" inactive-color="#ff4949" :active-value="1" :inactive-value="0"/>
          </template>
        </el-table-column>
        <el-table-column label="是否允许登录后台" min-width="130" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.is_admin" active-color="#13ce66" inactive-color="#ff4949" :active-value="1" :inactive-value="0"/>
          </template>
        </el-table-column>-->
        <el-table-column label="待办事项" min-width="130" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.is_backlog" disabled active-color="#13ce66" inactive-color="#ff4949" :active-value="1" :inactive-value="0"/>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="left" width="200" class-name="small-padding fixed-width">
          <template slot-scope="scope" v-if="scope.row.name !== '站经理'">
    ...
    <el-dialog :visible.sync="gangweitianjia" title="岗位添加" class="gwgl_tab">
      <el-form ref="gwtianjiaForm" :rules="rules" :model="gwtianjiaform" label-position="left" label-width="80px">
	       ...
	       <!-- <el-form-item label="资金缴存">
	        ...
	        <el-form-item label="是否允许登录收银机终端">
	          <el-switch
	        ...
	        <div style="margin-left: 60px;">
		        <el-form-item label="待办事项">
		          <el-switch
							  v-model="gwtianjiaform.is_backlog"
							  active-color="#13ce66"
							  inactive-color="#cccccc"
							  active-value="1"
	    					inactive-value="0">
