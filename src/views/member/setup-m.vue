  ...
  <div class="app-container setup">
    <el-form ref="form" :model="form" label-width="100px">
		  ...
		  <div class="guanli">
		  			...
		  			<!-- <div class="hao" @click="dengjiTk">+</div> -->
						<el-table :key="tableKey" :data="dengjiList" style="width: 100%;">
							...
							<!-- <el-table-column label="操作" align="left" min-width="150" class-name="small-padding fixed-width">
								<template slot-scope="scope">
									<el-button size="mini" type="primary" @click="dengjiModify(scope.$index, scope.row)">修改</el-button>
									<el-button size="mini" type="danger" @click="dengjiDel(scope.$index,scope.row)">删除</el-button>
								</template>
							</el-table-column> -->
						</el-table>
					</div>
		  	...
		  	<div class="dengji biaoqian">
		  		...
		  		<div class="jiahao">
			        ...
			        <el-table-column label="操作" align="left" min-width="150" class-name="small-padding fixed-width">
			          <template slot-scope="scope">
			            <el-button size="mini" type="primary" @click="modificationLabel(scope.$index, scope.row)">修改</el-button>
			            <el-button size="mini" type="danger" @click="biaoqianDel(scope.$index, scope.row)">删除</el-button>
			          </template>
			        </el-table-column>
	      		</el-table>
		  		</div>
		  	...
		  	<div class="dengji chedui">
		  		<div class="top">
		  			<el-form-item label="车队折扣管理" style="margin-bottom: 0;" label-width="130px"></el-form-item>
		  		</div>
		  		<div class="jiahao">
			        ...
			        <el-table-column label="油品" align="left" min-width="170">
			          <template slot-scope="scope">
						<span v-for="item in scope.row.oilsIds">
							<b style="font-weight: 500;" v-for="item1 in oilOptions" v-if="item1.id == item">{{ item1.oils_no_type }}</b>
						</span>
			          </template>
			        </el-table-column>
		...
		<el-dialog title="会员等级添加" :visible.sync="dengjitianjia" class="biaoqiantianjia">
	      <el-form ref="biaoqianForm" :model="temp" label-position="left" label-width="130px" style="width: 400px; margin-left:50px;">
	        <el-form-item label="会员等级" prop="title">
	          <el-input v-model="dengjiAddDada.membershipLevel"/>
	        </el-form-item>
					<el-form-item label="积分范围" prop="title">
	          <el-input v-model="dengjiAddDada.minPoint"/> <span>~</span> <el-input v-model="dengjiAddDada.maxPoint"/>
	        </el-form-item>
		...
		<el-dialog title="会员等级修改" :visible.sync="dengjixiugai" class="biaoqiantianjia">
	      <el-form ref="biaoqianForm" :model="temp" label-position="left" label-width="130px" style="width: 400px; margin-left:50px;">
	        <el-form-item label="会员等级" prop="title">
	          <el-input v-model="dengjiModifyDada.levelName"/>
	        </el-form-item>
					<el-form-item label="积分范围" prop="title">
	          <el-input v-model="dengjiModifyDada.minPoint"/> <span>~</span> <el-input v-model="dengjiModifyDada.maxPoint"/>
	        </el-form-item>
					<el-form-item label="积分乘数" prop="title">
    ...
    <el-dialog title="标签添加" :visible.sync="biaoqintianjia" class="biaoqiantianjia" width="1000px">
	      <el-form ref="biaoqianForm" :model="temp" label-position="left" label-width="130px" style="width: 400px; margin-left:50px;">
	        ...
	        <el-form-item label="月均加油次数" class="xiaoselect">
	          <el-select v-model="biaoqianAddDada.frequencyStartIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
			      ...
			      <el-input placeholder="" v-model="biaoqianAddDada.frequencyStart" style="width: 200px;" class="filter-item"/>
			      <div class="qie">且</div>
			      <el-select v-model="biaoqianAddDada.frequencyEndIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianAddDada.frequencyEnd" style="width: 200px;" class="filter-item"/>
	        </el-form-item>
	        
	        <el-form-item label="平均每次加油金额" class="xiaoselect">
	          <el-select v-model="biaoqianAddDada.averageStartIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianAddDada.averageStart" style="width: 200px;" class="filter-item"/>
			      <div class="qie">且</div>
			      <el-select v-model="biaoqianAddDada.averageEndIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianAddDada.averageEnd" style="width: 200px;" class="filter-item"/>
	        </el-form-item>
		...
		<el-dialog title="标签修改" :visible.sync="biaoqianxiugai" class="biaoqiantianjia" width="1000px">
	      <el-form ref="biaoqianForm" :model="temp" label-position="left" label-width="130px" style="width: 400px; margin-left:50px;">
	        ...
	        <el-form-item label="月均加油次数" class="xiaoselect">
	          <el-select v-model="biaoqianModifyDada.frequencyStartIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianModifyDada.frequencyStart" style="width: 200px;" class="filter-item"/>
			      <div class="qie">且</div>
			      <el-select v-model="biaoqianModifyDada.frequencyEndIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianModifyDada.frequencyEnd" style="width: 200px;" class="filter-item"/>
	        </el-form-item>
	        
	        <el-form-item label="平均每次加油金额" class="xiaoselect">
	          <el-select v-model="biaoqianModifyDada.averageStartIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianModifyDada.averageStart" style="width: 200px;" class="filter-item"/>
			      <div class="qie">且</div>
			      <el-select v-model="biaoqianModifyDada.averageEndIndex" clearable style="width: 90px" class="filter-item">
			        <el-option
							v-for="item in indexOptions"
							:key="item.value"
							:label="item.label"
			      ...
			      <el-input placeholder="" v-model="biaoqianModifyDada.averageEnd" style="width: 200px;" class="filter-item"/>
	        </el-form-item>
	        ...
	        <div class="xuanze">
	        	<el-form-item label="油品品号" class="xiaoselect">
		          <el-select v-model="biaoqianModifyDada.oilsIds" clearable class="filter-item" multiple collapse-tags>
				       <el-option
							v-for="item in oilOptions"
							:key="item.id"
							:label="item.oils_no_type"
		...
		<el-dialog title="折扣添加" :visible.sync="zhekoutianjia" class="zhekoutianjia" width="600px">
			<el-form ref="zhekouForm" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
				<el-form-item label="油品品号" class="youpinpinhao">
					<el-select v-model="zhekouAddDada.oilsIds" clearable class="filter-item" >
						 <el-option
							v-for="item in oilOptions"
							:key="item.id"
							:label="item.oils_no_type"
				...
				<el-form-item label="油品折扣" class="youpinzhekou">
					<el-input v-model="zhekouAddDada.discountStart"/>
					<div class="yuanms">元/升 ～ </div>
					<el-input v-model="zhekouAddDada.discountEnd"/>
					<div class="yuanms">元/升</div>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
				<el-button @click="zhekoutianjia = false">取消</el-button>
				<el-button type="primary" @click="zhekouAdd">保存</el-button>
			</div>
		</el-dialog>
		<el-dialog title="折扣修改" :visible.sync="zhekouxiugai" class="zhekoutianjia" width="600px">
	    <el-form ref="zhekouForm" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
				<el-form-item label="油品品号" class="youpinpinhao">
					<el-select v-model="zhekouModifyDada.oilsIds" clearable class="filter-item" >
						 <el-option
							v-for="item in oilOptions"
							:key="item.id"
							:label="item.oils_no_type"
				...
				<el-form-item label="油品折扣" class="youpinzhekou">
					<el-input v-model="zhekouModifyDada.discountStart"/>
					<div class="yuanms">元/升 ～ </div>
					<el-input v-model="zhekouModifyDada.discountEnd"/>
					<div class="yuanms">元/升</div>
				</el-form-item>
      </el-form>
			<div slot="footer" class="dialog-footer">
				<el-button @click="zhekouxiugai = false">取消</el-button>
				<el-button type="primary" @click="zhekouModifyEnt">保存</el-button>
			</div>
		</el-dialog>
  </div>
</template>
  ...
  methods: {
  	getList() {
  	  this.listLoading = true
			...
			//获取等级列表
			var data = {}
			queryAllMemberLevel(data)
				.then(response => {
					this.dengjiList = response.data.list
				})
			// this.$http
			// 	.post('http://192.168.0.129:8080/member/queryAllMemberLevel',
			// 	{},
			// 	{
			// 		headers:{
			...
			// 	})
				//获取标签列表
				queryMemberLabel(data)
					.then(response => {
						this.biaoqianList = response.data.list
					})
				// this.$http
				// .post('http://192.168.0.129:8080/member/queryMemberLabel',
				// {},
				// {
				// 	headers:{
				// 	'Authorization':'Cfyg-eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbjAifQ.EzOtp4tB1dD7xTGWIc5Dlceoi7undj9ikhDdkuz23N_te3iLoE61nqSd-X-9hmC_ERIdKMXu62ZHbuV4vqWzhQ'
				...
				// 	console.log('提交成功')
				// 	console.log(res.body)
				// 	this.biaoqianList = res.body.list
				// })
				// .catch(function(err){
				// 	console.log('提交失败')
				// 	console.log(err)
				// })
				//获取车队列表
				queryAllMemberCarDiscount(data)
					.then(response => {
						console.log('折扣')
				...
				// this.$http
				// .post('http://192.168.0.129:8080/member/queryAllMemberCarDiscount',
				// {},
				// {
				// 	headers:{
				// 		'Authorization':'Cfyg-eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbjAifQ.EzOtp4tB1dD7xTGWIc5Dlceoi7undj9ikhDdkuz23N_te3iLoE61nqSd-X-9hmC_ERIdKMXu62ZHbuV4vqWzhQ'
    ...
    zhekouTk(){
		...
		dengjiModifyEnt(){
			...
			// this.$http
			// 	.post('http://192.168.0.129:8080/member/updateMemberLevel',
			// 	{
			// 		"id":this.dengjiModifyDada.id,
			// 		"creater": "111",
			// 		"levelName": this.dengjiModifyDada.levelName,
			...
			// 		console.log(res.body)
			// 		this.dengjixiugai = false
			// 		this.dengjiList[this.dengjiIndex].levelName=this.dengjiModifyDada.levelName
			// 		this.dengjiList[this.dengjiIndex].maxPoint=this.dengjiModifyDada.maxPoint
			// 		this.dengjiList[this.dengjiIndex].minPoint=this.dengjiModifyDada.minPoint
			// 		this.dengjiList[this.dengjiIndex].multiple=this.dengjiModifyDada.multiple
			// 		this.$message({
			// 			message: '修改成功',
			// 			type: 'success'
			// 		});
		...
		dengjiDel(index,row){
			...
			// this.$http
			// 	.post('http://192.168.0.129:8080/member/deleteMemberLevel',
			// 	{
			// 		"id":row.id,
			// 	},
			// 	{
		...
		biaoqianAdd(){
			...
			var data = {
					...
					"averageEndIndex": Number(this.biaoqianAddDada.averageEndIndex)||0,
					"averageStart": Number(this.biaoqianAddDada.averageStart),
					"averageStartIndex": Number(this.biaoqianAddDada.averageStartIndex)||0,
					"frequencyEnd":  Number(this.biaoqianAddDada.frequencyEnd),
					"frequencyEndIndex": Number(this.biaoqianAddDada.frequencyEndIndex)||0,
					"frequencyStart": Number(this.biaoqianAddDada.frequencyStart),
					"frequencyStartIndex": Number(this.biaoqianAddDada.frequencyStartIndex)||0,
			...
			// this.$http
			// 	.post('http://192.168.0.129:8080/member/addMemberLabel',
			// 	{
			// 		"averageEnd": Number(this.biaoqianAddDada.averageEnd),
			// 		"averageEndIndex": Number(this.biaoqianAddDada.averageEndIndex)||0,
			// 		"averageStart": Number(this.biaoqianAddDada.averageStart),
			...
			// 		console.log(res.body)
			// 		this.biaoqintianjia = false
			// 		this.biaoqianList.push(res.body)
			// 		this.biaoqianAddDada = {
			// 			averageEnd: "",//平均
			// 			averageEndIndex: '',
			// 			averageStartIndex: '',
			// 			averageStart: "",
		...
		zhekouModifyEnt(){
			let oilsIds = this.zhekouModifyDada.oilsIds
			var data = {
