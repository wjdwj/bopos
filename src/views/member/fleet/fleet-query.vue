        ...
        <div class="table">
          <el-table
            ...
            <el-table-column
              ...
              align="center">
              <template slot-scope="scope">
                <span v-show="scope.row.createTime">{{ scope.row.createTime| parseTime('{y}-{m}-{d}') }}</span>
              </template>
            </el-table-column>
                  <el-table-column
              label="开户日期"
            ...
            <el-table-column
              ...
              align="center">
              <template slot-scope="scope">
                <span v-show="scope.row.mcardStatus==0">正常</span>
                <span v-show="scope.row.mcardStatus==1">冻结</span>
              </template>
            </el-table-column>
