    ...
    <div class="warp">
        ...
        <div class="main">
            <div class="footer">
                ...
                <div class="biao">
                    <div class="table">
                        <el-table :data="tableData" stripe style="width: 100%">
                            ...
                            <el-table-column label="主卡号" align="center">
                                <template slot-scope="scope">
                            ...
                            <el-table-column label="充值地点" min-width="120" align="center">
                                <template slot-scope="scope">
                                    <span
                                        v-show="scope.row.rechargeType != '1'"
                                    >{{scope.row.shortName}}</span>
                                    <span v-show="scope.row.rechargeType == '1'">微信公众平台</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="操作人员" min-width="100" align="center">
                                <template slot-scope="scope">
                                    <span
                                        v-show="scope.row.rechargeType != '1'"
                            ...
                            <el-table-column label="操作" align="center" min-width="80">
                                <template slot-scope="scope">
                                    <div v-if="scope.row.status==-1">
                                        <el-button
                                            type="primary"
                                            @click="returnSee(scope.$index, scope.row)"
                                        >查看</el-button>
                                    </div>
                                    <div v-if="scope.row.status==0||scope.row.status==1">
                                        <el-button
                                            type="primary"
                                            @click="dai(scope.$index, scope.row)"
                                        >查看</el-button>
                                    </div>
                                    <div
                                    ...
                                    >
                                        <el-button
                                            type="primary"
                                            v-if="scope.row.rechargeMode=='银联卡'"
                                            @click="cardSee(scope.$index, scope.row)"
                                        >查看</el-button>
                                        <el-button
                                            type="primary"
                                            v-if="scope.row.rechargeMode!='银联卡'"
                                            @click="weiSee(scope.$index, scope.row)"
                                        >查看</el-button>
                                    </div>
                                </template>
                            </el-table-column>
                ...
                <!-- 退回充值记录 -->
                <el-dialog :visible.sync="returnVisible" title="交易记录" width="60%">
                    <div class="screen">
                        <el-row>
                            <el-col :span="12">
                                <div class="grid-content bg-purple">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="right">
                                            <el-input
                                                v-model="seeData.rechargeAmount"
                                                placeholder
                                                style="width:100px;"
                                            ></el-input>元
                                        </div>
                ...
                <!-- 银联卡充值记录 -->
                <el-dialog :visible.sync="cardVisible" title="交易记录" width="60%">
                    <div class="screen">
                        <el-row>
                            <el-col :span="12">
                                <div class="grid-content bg-purple">
                ...
                <!-- 微信/支付宝充值记录 -->
                <el-dialog :visible.sync="weiVisible" title="交易记录" width="60%">
                    <div class="screen">
                        <el-row>
                            <el-col :span="12">
                                <div class="grid-content bg-purple">
                ...
                <!-- 待审核充值记录 -->
                <el-dialog :visible.sync="daiVisible" title="交易记录" width="60%">
                    <div class="screen">
                        <el-row>
                            <el-col :span="12">
                                <div class="grid-content bg-purple">
                    ...
                    <div slot="footer" class="dialog-footer">
                        ...
                        <el-button type="primary" @click="queren">确认入账</el-button>
...
import { updateMotorcadeReChargeById } from "@/api/cheduiguanli";
...
export default {
    data() {
        return {
            search: "", //搜索
            membershipNumber: "3456789987654", //会员号
            contacts: "张三", //联系人
            unitName: "北京哇哈哈有限公司", //单位名称
            mobileNumber: "12345667899", //手机号
            membershipLevel: "砖石", //会员等级
            integral: "300", //积分
            accountBalance: "500", //账户余额
            membership: "", //会员号/会员名称
            rechargeMode: "", //充值方式
            rechargeOptions: [
                {
    ...
    methods: {
        ...
        queren() {
            var data = {
                rechargeNum: this.seeData.rechargeNum,
                status: 1
            };
            updateMotorcadeReChargeById(data).then(response => {
                console.log(response.data);
