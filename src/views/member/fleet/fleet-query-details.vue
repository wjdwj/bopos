    ...
    <div class="main">
        <div class="top">
            ...
            <div class="xinxi">
                ...
                <div class="box">
                    <div class="shang">子卡数量：{{this.tableData.length}}</div>
        ...
        <div class="footer">
            <div class="header">
                <h3><span></span>车队管理员信息 <el-input v-model="phone" placeholder="请输入内容" style="width: 200px;margin-left: 20px;"></el-input> <el-button  type="primary" @click="cha">查询</el-button></h3>
            </div> 
            <div class="guanli">
                <el-row>
                    <el-col :span="12">
