    ...
    <el-tab-pane label="电子优惠券">
        ...
        <div class="biao">
            <el-table
                ...
                align='center'>
                    <template slot-scope="scope">
                        <span v-if="scope.row.couponType==1">{{ scope.row.couponDiscount }}元</span>
                    </template>
                </el-table-column>
                <el-table-column
                label="折扣比例"
                ...
                align='center'>
                    <template slot-scope="scope">
                        <span>{{ scope.row.minimumCharge }}元</span>
                    </template>
                </el-table-column>
                <el-table-column
                label="有效期"
                align='center'>
                    <template slot-scope="scope">
                        <span>{{ scope.row.periodOfValidity }}天</span>
                    </template>
                </el-table-column>
                <el-table-column
                label="状态"
                align='center'>
                    <template slot-scope="scope">
                        ...
                        <span v-show="scope.row.status==0">已停止</span>
                    </template>
                </el-table-column>
