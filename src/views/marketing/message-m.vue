			...
			<el-tabs v-model="activeName" @tab-click="handleClick">
					...
					<el-dialog :visible.sync="screenVisible" title="筛选" width="90%">
						<div class="sai">
							...
							<div class="block">
								...
								<div class="right">
								<el-select style="width: 90px;" clearable v-model="screen.amoutIndex" placeholder="请选择">
									<el-option
							...
							<div class="block">
								...
								<div class="right">
								<el-select style="width: 90px;" clearable v-model="screen.currentPointIndex" placeholder="请选择">
									<el-option
									v-for="item in amoutIndexOptions"
									:key="item.value"
									:label="item.label"
				...
				<el-tab-pane label="历史信息" name="second">
					<div class="table">
						<el-table
							...
							<template slot-scope="scope">
								<el-button type="primary" size="small" @click="see(scope.$index, scope.row)">查看</el-button>
							</template>
							</el-table-column>
						</el-table>
					</div>
					...
					<el-dialog :visible.sync="sendVisible" width='70%' title="短信模板">
						<div class="send">
							<div class="top">
								<p style="width: 240px;">发送时间：{{seeSend.sendingTime}}</p>
	...
	export default {
		...
		data() {
			return {
				...
				checked: true,//定时发送是否选中
				sendDate:'',//定时发送日期
				sendTime:'',//定时发送时间
				previewContents:'【三统石油】别等双十一，天天都是狂欢节！8月1日起，油品7折优惠详情请关注公众号（三统石油），退订回复T。',//短信预览内容
