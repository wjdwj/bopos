    ...
    <div class="warp">
        ...
        <div class="main">
            ...
            <div class="table">
                ...
                >
                    <el-table-column prop="id" label="班结编号"  width="130"  align="center"></el-table-column>
                    <el-table-column prop="businessDate" label="营业日"  align="center"></el-table-column>
                    <!-- <el-table-column prop="companyName" label="公司"  align="center"></el-table-column> -->
                    <el-table-column prop="stationName" label="加油站"  align="center"></el-table-column>
                    <el-table-column prop="createDate" label="开班时间"  align="center"></el-table-column>
                    <el-table-column prop="modifyDate" label="结班时间"  align="center"></el-table-column>
                    <el-table-column prop="businessAmount" label="营业金额" min-width="100"  align="center"></el-table-column>
                    ...
                    <el-table-column prop="modifyName" label="班结人员"  align="center"></el-table-column>
...
// 	    },
    ...
    methods: {
		...
		//     	this.listQuery.beginTime=this.data[0];
		//     	this.listQuery.endTime=this.data[1];
	    // 	}else{
