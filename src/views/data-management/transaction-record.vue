            ...
            <div class="biao publicTable thColorDark">
                <div class="table">
                    <el-table :data="tableData" style="width: 100%">
                        <el-table-column align="left" label="交易时间" min-width="170px">
                            <template slot-scope="scope">
                                <span>{{ scope.row.createTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
                                <!-- <span>2019-01-02 10:00:00</span> -->
                            </template>
                        </el-table-column>
                        <el-table-column prop="companyName" label="公司" align="left" min-width="120px"></el-table-column>
                        <el-table-column prop="orderNo" label="交易流水号" align="left" min-width="140px"></el-table-column>
                        <el-table-column label="加油站" prop="fullName" align="left" min-width="140px"></el-table-column>
                        <el-table-column label="商品类型" align="left" min-width="90px">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="交易类型" prop="orderGoodsType" align="left" min-width="90px">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="金额" prop="totalPrice" align="left" min-width="100px"></el-table-column>
                        <!-- <el-table-column label="顾客类型" prop="member" align="left">
                        </el-table-column>-->
                        <el-table-column label="优惠" prop="couponCount" align="left" min-width="100px">
                            <template slot-scope="scope">
                                <span v-show="scope.row.couponCount==0">无</span>
                                <span v-show="scope.row.couponCount>0">有</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="收银员" prop="username" align="left" min-width="80px"></el-table-column>
                        <el-table-column label="操作" prop="member" align="center" min-width="120">
                            <template slot-scope="scope">
                                <el-button
                  ...
                  <div class="edit">
                      <div class="top">
                          <div class="box">
                              ...
                              <div class="block">
                                  <span><b>操作时间：</b>{{seeData.detail.create_time | parseTime('{y}-{m}-{d}')}}</span>
                                  <span></span>
                              </div>
                          ...
                          <div class="box">
                              ...
                              <div class="block">
                                  <span><b>枪号：</b>{{seeData.detail.oil_gun_no}}</span>
                                  <span></span>
                              </div>
                          </div>
                      </div>
...
/* .edit .biao >>> th{background: #f5f9fc;} */
